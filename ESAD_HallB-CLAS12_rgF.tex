...
for the Hall B CLAS12 Run Group F}
\date{\today\\v2.0}
...
Experimental Equipment for the CLAS12 RG F Run. Many of these subsystems impose 
...
The Hall~B equipment readiness for the beam run will be checked using the CEBAF Hot Checkout 
